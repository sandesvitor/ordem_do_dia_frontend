...
export class Recursos extends Component {
    ...
    render() {
        return (               
                <div className="recursos-section" id="recursos">                 
                    <ul className="top-recursos">
                        <li> 
                    ...
                    <ul className="sub-recursos">
                        ...
                        <li>
                            <p>Organiza sua própria agenda de contatos e<br/>envie os documentos diretamente para cada<br/>integrante da sua equipe de forma personalizada</p>
                        </li>
                    </ul>                          
                </div>    
